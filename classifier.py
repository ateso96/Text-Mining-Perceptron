...
def classifyMP(x_train, x_test, y_train, y_test):
    ...
    bestParameters = perceptron.best_params_
    results = "************************************" \
    ...
    perceptron = MLPClassifier(max_iter=['max_iter'], solver=bestParameters['solver'], alpha=bestParameters['alpha'],
